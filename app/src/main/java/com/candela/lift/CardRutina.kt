...
fun CardRutina() {
    ...
    var numeroSeries by rememberSaveable { mutableIntStateOf(0) }
    var numeroKG by rememberSaveable { mutableStateOf("") }
    var numeroReps by rememberSaveable { mutableStateOf("") }
